...
public class GetNetworkProfileResponseNetworkProfile {
  ...
  public GetNetworkProfileResponseNetworkProfile() {
  }

  public GetNetworkProfileResponseNetworkProfile networkProfileArn(@javax.annotation.Nullable String networkProfileArn) {
  ...
  public GetNetworkProfileResponseNetworkProfile networkProfileName(@javax.annotation.Nullable String networkProfileName) {
  ...
  public GetNetworkProfileResponseNetworkProfile description(@javax.annotation.Nullable String description) {
  ...
  public GetNetworkProfileResponseNetworkProfile ssid(@javax.annotation.Nullable String ssid) {
    this.ssid = ssid;
    return this;
  }
  ...
  public GetNetworkProfileResponseNetworkProfile securityType(@javax.annotation.Nullable NetworkSecurityType securityType) {
  ...
  public GetNetworkProfileResponseNetworkProfile eapMethod(@javax.annotation.Nullable NetworkEapMethod eapMethod) {
  ...
  public GetNetworkProfileResponseNetworkProfile currentPassword(@javax.annotation.Nullable String currentPassword) {
  ...
  public GetNetworkProfileResponseNetworkProfile nextPassword(@javax.annotation.Nullable String nextPassword) {
  ...
  public GetNetworkProfileResponseNetworkProfile certificateAuthorityArn(@javax.annotation.Nullable String certificateAuthorityArn) {
  ...
  public GetNetworkProfileResponseNetworkProfile trustAnchors(@javax.annotation.Nullable List trustAnchors) {
  ...
  public boolean equals(Object o) {
    ...
    GetNetworkProfileResponseNetworkProfile getNetworkProfileResponseNetworkProfile = (GetNetworkProfileResponseNetworkProfile) o;
    return Objects.equals(this.networkProfileArn, getNetworkProfileResponseNetworkProfile.networkProfileArn) &&
        Objects.equals(this.networkProfileName, getNetworkProfileResponseNetworkProfile.networkProfileName) &&
        Objects.equals(this.description, getNetworkProfileResponseNetworkProfile.description) &&
        Objects.equals(this.ssid, getNetworkProfileResponseNetworkProfile.ssid) &&
        Objects.equals(this.securityType, getNetworkProfileResponseNetworkProfile.securityType) &&
        Objects.equals(this.eapMethod, getNetworkProfileResponseNetworkProfile.eapMethod) &&
        Objects.equals(this.currentPassword, getNetworkProfileResponseNetworkProfile.currentPassword) &&
        Objects.equals(this.nextPassword, getNetworkProfileResponseNetworkProfile.nextPassword) &&
        Objects.equals(this.certificateAuthorityArn, getNetworkProfileResponseNetworkProfile.certificateAuthorityArn) &&
        Objects.equals(this.trustAnchors, getNetworkProfileResponseNetworkProfile.trustAnchors);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetNetworkProfileResponseNetworkProfile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetNetworkProfileResponseNetworkProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetNetworkProfileResponseNetworkProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetNetworkProfileResponseNetworkProfile is not found in the empty JSON string", GetNetworkProfileResponseNetworkProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetNetworkProfileResponseNetworkProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetNetworkProfileResponseNetworkProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetNetworkProfileResponseNetworkProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetNetworkProfileResponseNetworkProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetNetworkProfileResponseNetworkProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetNetworkProfileResponseNetworkProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<GetNetworkProfileResponseNetworkProfile>() {
           @Override
           public void write(JsonWriter out, GetNetworkProfileResponseNetworkProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetNetworkProfileResponseNetworkProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetNetworkProfileResponseNetworkProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetNetworkProfileResponseNetworkProfile
   * @throws IOException if the JSON string is invalid with respect to GetNetworkProfileResponseNetworkProfile
   */
  public static GetNetworkProfileResponseNetworkProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNetworkProfileResponseNetworkProfile.class);
  }

  /**
   * Convert an instance of GetNetworkProfileResponseNetworkProfile to an JSON string
   *
   * @return JSON string
   */
