...
public class SkillDetails {
  ...
  public SkillDetails productDescription(@javax.annotation.Nullable String productDescription) {
  ...
  public SkillDetails invocationPhrase(@javax.annotation.Nullable String invocationPhrase) {
  ...
  public SkillDetails releaseDate(@javax.annotation.Nullable String releaseDate) {
  ...
  public SkillDetails endUserLicenseAgreement(@javax.annotation.Nullable String endUserLicenseAgreement) {
  ...
  public SkillDetails genericKeywords(@javax.annotation.Nullable List genericKeywords) {
  ...
  public SkillDetails bulletPoints(@javax.annotation.Nullable List bulletPoints) {
  ...
  public SkillDetails newInThisVersionBulletPoints(@javax.annotation.Nullable List newInThisVersionBulletPoints) {
  ...
  public SkillDetails skillTypes(@javax.annotation.Nullable List skillTypes) {
  ...
  public SkillDetails reviews(@javax.annotation.Nullable Map reviews) {
  ...
  public SkillDetails developerInfo(@javax.annotation.Nullable SkillDetailsDeveloperInfo developerInfo) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.productDescription, skillDetails.productDescription) &&
        Objects.equals(this.invocationPhrase, skillDetails.invocationPhrase) &&
        Objects.equals(this.releaseDate, skillDetails.releaseDate) &&
        Objects.equals(this.endUserLicenseAgreement, skillDetails.endUserLicenseAgreement) &&
        Objects.equals(this.genericKeywords, skillDetails.genericKeywords) &&
        Objects.equals(this.bulletPoints, skillDetails.bulletPoints) &&
        Objects.equals(this.newInThisVersionBulletPoints, skillDetails.newInThisVersionBulletPoints) &&
        Objects.equals(this.skillTypes, skillDetails.skillTypes) &&
        Objects.equals(this.reviews, skillDetails.reviews) &&
        Objects.equals(this.developerInfo, skillDetails.developerInfo);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SkillDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SkillDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SkillDetails is not found in the empty JSON string", SkillDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SkillDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SkillDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SkillDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SkillDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SkillDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SkillDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<SkillDetails>() {
           @Override
           public void write(JsonWriter out, SkillDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SkillDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SkillDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SkillDetails
   * @throws IOException if the JSON string is invalid with respect to SkillDetails
   */
  public static SkillDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SkillDetails.class);
  }

  /**
   * Convert an instance of SkillDetails to an JSON string
   *
   * @return JSON string
   */
