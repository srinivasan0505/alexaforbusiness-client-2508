...
public class Category {
  ...
  public Category categoryId(@javax.annotation.Nullable Integer categoryId) {
  ...
  public Category categoryName(@javax.annotation.Nullable String categoryName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `CategoryId`
      if (jsonObj.get("CategoryId") != null && !jsonObj.get("CategoryId").isJsonNull()) {
