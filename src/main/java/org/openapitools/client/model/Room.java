...
public class Room {
  ...
  public Room roomArn(@javax.annotation.Nullable String roomArn) {
  ...
  public Room roomName(@javax.annotation.Nullable String roomName) {
  ...
  public Room description(@javax.annotation.Nullable String description) {
  ...
  public Room providerCalendarId(@javax.annotation.Nullable String providerCalendarId) {
  ...
  public Room profileArn(@javax.annotation.Nullable String profileArn) {
  ...
  public boolean equals(Object o) {
    ...
    Room room = (Room) o;
    return Objects.equals(this.roomArn, room.roomArn) &&
        Objects.equals(this.roomName, room.roomName) &&
        Objects.equals(this.description, room.description) &&
        Objects.equals(this.providerCalendarId, room.providerCalendarId) &&
        Objects.equals(this.profileArn, room.profileArn);
  }
