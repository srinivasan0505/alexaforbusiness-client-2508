...
import org.openapitools.client.model.GetDeviceResponseDevice;
...
public class GetDeviceResponse {
  ...
  private GetDeviceResponseDevice device;

  public GetDeviceResponse() {
  }

  public GetDeviceResponse device(@javax.annotation.Nullable GetDeviceResponseDevice device) {
    this.device = device;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GetDeviceResponseDevice getDevice() {
    return device;
  }

  public void setDevice(@javax.annotation.Nullable GetDeviceResponseDevice device) {
    this.device = device;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.device, getDeviceResponse.device);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Device") != null && !jsonObj.get("Device").isJsonNull()) {
        GetDeviceResponseDevice.validateJsonElement(jsonObj.get("Device"));
      }
  }
