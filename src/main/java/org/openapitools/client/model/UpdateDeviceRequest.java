...
public class UpdateDeviceRequest {
  ...
  public UpdateDeviceRequest deviceArn(@javax.annotation.Nullable String deviceArn) {
  ...
  public UpdateDeviceRequest deviceName(@javax.annotation.Nullable String deviceName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deviceArn, updateDeviceRequest.deviceArn) &&
        Objects.equals(this.deviceName, updateDeviceRequest.deviceName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceArn, deviceName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDeviceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDeviceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDeviceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDeviceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
