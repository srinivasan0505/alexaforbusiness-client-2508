...
public class ApiClient {
    ...
    private String basePath = "http://a4b.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://a4b.{region}.amazonaws.com",
      "The Alexa For Business multi-region endpoint",
    ...
    new ServerConfiguration(
      "https://a4b.{region}.amazonaws.com",
      "The Alexa For Business multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://a4b.{region}.amazonaws.com.cn",
      "The Alexa For Business endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
          "cn-north-1",
    ...
    new ServerConfiguration(
      "https://a4b.{region}.amazonaws.com.cn",
      "The Alexa For Business endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-11-09/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://a4b.us-east-1.amazonaws.com
