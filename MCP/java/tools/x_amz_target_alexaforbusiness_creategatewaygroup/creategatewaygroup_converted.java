/**
 * MCP Server function for Creates a gateway group with the specified details.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_Create_Gateway_GroupMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_Create_Gateway_GroupHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("Name")) {
            queryParams.add("Name=" + args.get("Name"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_create_gateway_group" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_Create_Gateway_GroupTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_create_gateway_group",
            "Creates a gateway group with the specified details.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_Create_Gateway_GroupHandler(config));
    }
