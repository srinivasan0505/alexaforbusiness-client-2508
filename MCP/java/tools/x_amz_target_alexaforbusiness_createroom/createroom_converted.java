/**
 * MCP Server function for Creates a room with the specified details.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_Create_RoomMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_Create_RoomHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("RoomName")) {
            queryParams.add("RoomName=" + args.get("RoomName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_create_room" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_Create_RoomTool(MCPServer.APIConfig config) {
        ...
        RoomNameProperty.put("required", true);
        RoomNameProperty.put("description", "");
        properties.put("RoomName", RoomNameProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_create_room",
            "Creates a room with the specified details.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_Create_RoomHandler(config));
    }
