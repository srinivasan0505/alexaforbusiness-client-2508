/**
 * MCP Server function for Retrieves a list of gateway group summaries. Use GetGatewayGroup to retrieve details of a specific gateway group.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_List_Gateway_GroupsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_List_Gateway_GroupsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("X-Amz-Target")) {
            queryParams.add("X-Amz-Target=" + args.get("X-Amz-Target"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_list_gateway_groups" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_List_Gateway_GroupsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_list_gateway_groups",
            "Retrieves a list of gateway group summaries. Use GetGatewayGroup to retrieve details of a specific gateway group.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_List_Gateway_GroupsHandler(config));
    }
