/**
 * MCP Server function for Lists all categories in the Alexa skill store.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_List_Skills_Store_CategoriesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_List_Skills_Store_CategoriesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("X-Amz-Target")) {
            queryParams.add("X-Amz-Target=" + args.get("X-Amz-Target"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_list_skills_store_categories" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_List_Skills_Store_CategoriesTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_list_skills_store_categories",
            "Lists all categories in the Alexa skill store.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_List_Skills_Store_CategoriesHandler(config));
    }
