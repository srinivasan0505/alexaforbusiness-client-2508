/**
 * MCP Server function for Adds a new conference provider under the user's AWS account.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_Create_Conference_ProviderMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_Create_Conference_ProviderHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("ConferenceProviderName")) {
            queryParams.add("ConferenceProviderName=" + args.get("ConferenceProviderName"));
        }
        ...
        if (args.containsKey("PSTNDialIn")) {
            queryParams.add("PSTNDialIn=" + args.get("PSTNDialIn"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_create_conference_provider" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_Create_Conference_ProviderTool(MCPServer.APIConfig config) {
        ...
        Map<String, Object> ConferenceProviderNameProperty = new HashMap<>();
        ConferenceProviderNameProperty.put("type", "string");
        ConferenceProviderNameProperty.put("required", true);
        ConferenceProviderNameProperty.put("description", "");
        properties.put("ConferenceProviderName", ConferenceProviderNameProperty);
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_create_conference_provider",
            "Adds a new conference provider under the user's AWS account.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_Create_Conference_ProviderHandler(config));
    }
