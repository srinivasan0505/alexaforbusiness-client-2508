/**
 * MCP Server function for Updates the configuration of the report delivery schedule with the specified schedule ARN.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_Update_Business_Report_ScheduleMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_Update_Business_Report_ScheduleHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("ScheduleArn")) {
            queryParams.add("ScheduleArn=" + args.get("ScheduleArn"));
        }
        ...
        if (args.containsKey("Recurrence")) {
            queryParams.add("Recurrence=" + args.get("Recurrence"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_update_business_report_schedule" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_Update_Business_Report_ScheduleTool(MCPServer.APIConfig config) {
        ...
        FormatProperty.put("required", false);
        ...
        Map<String, Object> ScheduleArnProperty = new HashMap<>();
        ScheduleArnProperty.put("type", "string");
        ScheduleArnProperty.put("required", true);
        ScheduleArnProperty.put("description", "");
        properties.put("ScheduleArn", ScheduleArnProperty);
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_update_business_report_schedule",
            "Updates the configuration of the report delivery schedule with the specified schedule ARN.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_Update_Business_Report_ScheduleHandler(config));
    }
