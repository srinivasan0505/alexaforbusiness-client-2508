/**
 * MCP Server function for Creates a contact with the specified details.
 */
...
class Post_X_Amz_Target_Alexa_For_Business_Create_ContactMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Alexa_For_Business_Create_ContactHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("ClientRequestToken")) {
            queryParams.add("ClientRequestToken=" + args.get("ClientRequestToken"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_alexa_for_business_create_contact" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Alexa_For_Business_Create_ContactTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_alexa_for_business_create_contact",
            "Creates a contact with the specified details.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Alexa_For_Business_Create_ContactHandler(config));
    }
