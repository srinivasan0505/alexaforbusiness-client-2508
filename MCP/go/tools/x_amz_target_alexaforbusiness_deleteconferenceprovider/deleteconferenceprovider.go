...
func DeleteconferenceproviderHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteConferenceProviderRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteConferenceProvider", cfg.BaseURL)
		...
		var result models.DeleteConferenceProviderResponse
...
func CreateDeleteconferenceproviderTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteConferenceProvider",
		mcp.WithDescription("Deletes a conference provider."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteconferenceproviderHandler(cfg),
	}
}
