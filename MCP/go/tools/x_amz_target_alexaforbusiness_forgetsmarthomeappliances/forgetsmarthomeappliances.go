...
func ForgetsmarthomeappliancesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ForgetSmartHomeAppliancesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ForgetSmartHomeAppliances", cfg.BaseURL)
		...
		var result models.ForgetSmartHomeAppliancesResponse
...
func CreateForgetsmarthomeappliancesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ForgetSmartHomeAppliances",
		mcp.WithDescription("Forgets smart home appliances associated to a room."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ForgetsmarthomeappliancesHandler(cfg),
	}
}
