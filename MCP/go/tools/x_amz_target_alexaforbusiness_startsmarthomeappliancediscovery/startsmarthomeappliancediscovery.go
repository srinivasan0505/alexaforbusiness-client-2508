...
func StartsmarthomeappliancediscoveryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StartSmartHomeApplianceDiscoveryRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.StartSmartHomeApplianceDiscovery", cfg.BaseURL)
		...
		var result models.StartSmartHomeApplianceDiscoveryResponse
...
func CreateStartsmarthomeappliancediscoveryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_StartSmartHomeApplianceDiscovery",
		mcp.WithDescription("Initiates the discovery of any smart home appliances associated with the room."),
		...
		mcp.WithString("RoomArn", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    StartsmarthomeappliancediscoveryHandler(cfg),
	}
}
