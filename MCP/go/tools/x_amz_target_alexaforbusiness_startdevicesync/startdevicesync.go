...
func StartdevicesyncHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StartDeviceSyncRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.StartDeviceSync", cfg.BaseURL)
		...
		var result models.StartDeviceSyncResponse
...
func CreateStartdevicesyncTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_StartDeviceSync",
		...
		mcp.WithString("Features", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    StartdevicesyncHandler(cfg),
	}
}
