...
func DeleteroomskillparameterHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteRoomSkillParameterRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteRoomSkillParameter", cfg.BaseURL)
		...
		var result models.DeleteRoomSkillParameterResponse
...
func CreateDeleteroomskillparameterTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteRoomSkillParameter",
		mcp.WithDescription("Deletes room skill parameter details by room, skill, and parameter key ID."),
		...
		mcp.WithString("ParameterKey", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteroomskillparameterHandler(cfg),
	}
}
