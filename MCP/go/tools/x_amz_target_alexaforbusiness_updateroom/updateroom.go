...
func UpdateroomHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateRoomRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateRoom", cfg.BaseURL)
		...
		var result models.UpdateRoomResponse
...
func CreateUpdateroomTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateRoom",
		mcp.WithDescription("Updates room details by room ARN."),
		...
		mcp.WithString("ProviderCalendarId", mcp.Description("")),
		mcp.WithString("RoomArn", mcp.Description("")),
		mcp.WithString("RoomName", mcp.Description("")),
