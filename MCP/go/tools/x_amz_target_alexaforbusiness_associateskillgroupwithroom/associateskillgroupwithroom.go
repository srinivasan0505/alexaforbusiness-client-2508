...
func AssociateskillgroupwithroomHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AssociateSkillGroupWithRoomRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.AssociateSkillGroupWithRoom", cfg.BaseURL)
		...
		var result models.AssociateSkillGroupWithRoomResponse
...
func CreateAssociateskillgroupwithroomTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_AssociateSkillGroupWithRoom",
		mcp.WithDescription("Associates a skill group with a given room. This enables all skills in the associated skill group on all devices in the room."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AssociateskillgroupwithroomHandler(cfg),
	}
}
