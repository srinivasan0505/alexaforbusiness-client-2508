...
func GetskillgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetSkillGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetSkillGroup", cfg.BaseURL)
		...
		var result models.GetSkillGroupResponse
...
func CreateGetskillgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetSkillGroup",
		mcp.WithDescription("Gets skill group details by skill group ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetskillgroupHandler(cfg),
	}
}
