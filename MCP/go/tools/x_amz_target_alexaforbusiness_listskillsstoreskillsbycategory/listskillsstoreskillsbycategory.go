...
func ListskillsstoreskillsbycategoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListSkillsStoreSkillsByCategoryRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListSkillsStoreSkillsByCategory%s", cfg.BaseURL, queryString)
		...
		var result models.ListSkillsStoreSkillsByCategoryResponse
...
func CreateListskillsstoreskillsbycategoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListSkillsStoreSkillsByCategory",
		mcp.WithDescription("Lists all skills in the Alexa skill store by category."),
		...
		mcp.WithString("CategoryId", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListskillsstoreskillsbycategoryHandler(cfg),
	}
}
