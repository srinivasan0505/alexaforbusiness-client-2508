...
func SearchprofilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchProfilesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchProfiles%s", cfg.BaseURL, queryString)
		...
		var result models.SearchProfilesResponse
...
func CreateSearchprofilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchProfiles",
		mcp.WithDescription("Searches room profiles and lists the ones that meet a set of filter criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchprofilesHandler(cfg),
	}
}
