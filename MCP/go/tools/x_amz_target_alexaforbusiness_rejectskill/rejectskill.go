...
func RejectskillHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RejectSkillRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.RejectSkill", cfg.BaseURL)
		...
		var result models.RejectSkillResponse
...
func CreateRejectskillTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_RejectSkill",
		mcp.WithDescription("Disassociates a skill from the organization under a user's AWS account. If the skill is a private skill, it moves to an AcceptStatus of PENDING. Any private or public skill that is rejected can be added later by calling the ApproveSkill API. "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RejectskillHandler(cfg),
	}
}
