...
func DeletenetworkprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteNetworkProfileRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteNetworkProfile", cfg.BaseURL)
		...
		var result models.DeleteNetworkProfileResponse
...
func CreateDeletenetworkprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteNetworkProfile",
		mcp.WithDescription("Deletes a network profile by the network profile ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletenetworkprofileHandler(cfg),
	}
}
