...
func CreategatewaygroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateGatewayGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateGatewayGroup", cfg.BaseURL)
		...
		var result models.CreateGatewayGroupResponse
...
func CreateCreategatewaygroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateGatewayGroup",
		mcp.WithDescription("Creates a gateway group with the specified details."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreategatewaygroupHandler(cfg),
	}
}
