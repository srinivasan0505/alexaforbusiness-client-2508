...
func SearchskillgroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchSkillGroupsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchSkillGroups%s", cfg.BaseURL, queryString)
		...
		var result models.SearchSkillGroupsResponse
...
func CreateSearchskillgroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchSkillGroups",
		mcp.WithDescription("Searches skill groups and lists the ones that meet a set of filter and sort criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchskillgroupsHandler(cfg),
	}
}
