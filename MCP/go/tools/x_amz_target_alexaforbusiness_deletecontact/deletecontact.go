...
func DeletecontactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteContactRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteContact", cfg.BaseURL)
		...
		var result models.DeleteContactResponse
...
func CreateDeletecontactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteContact",
		mcp.WithDescription("Deletes a contact by the contact ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecontactHandler(cfg),
	}
}
