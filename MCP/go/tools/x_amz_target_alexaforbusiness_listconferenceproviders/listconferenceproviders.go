...
func ListconferenceprovidersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListConferenceProvidersRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListConferenceProviders%s", cfg.BaseURL, queryString)
		...
		var result models.ListConferenceProvidersResponse
...
func CreateListconferenceprovidersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListConferenceProviders",
		mcp.WithDescription("Lists conference providers under a specific AWS account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListconferenceprovidersHandler(cfg),
	}
}
