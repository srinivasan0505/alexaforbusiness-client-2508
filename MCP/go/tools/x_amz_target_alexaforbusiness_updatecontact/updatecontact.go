...
func UpdatecontactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateContactRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateContact", cfg.BaseURL)
		...
		var result models.UpdateContactResponse
...
func CreateUpdatecontactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateContact",
		mcp.WithDescription("Updates the contact details by the contact ARN."),
		...
		mcp.WithString("PhoneNumber", mcp.Description("")),
		mcp.WithString("PhoneNumbers", mcp.Description("")),
		mcp.WithString("SipAddresses", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatecontactHandler(cfg),
	}
}
