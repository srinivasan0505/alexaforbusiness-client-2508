...
func ListsmarthomeappliancesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListSmartHomeAppliancesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListSmartHomeAppliances%s", cfg.BaseURL, queryString)
		...
		var result models.ListSmartHomeAppliancesResponse
...
func CreateListsmarthomeappliancesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListSmartHomeAppliances",
		mcp.WithDescription("Lists all of the smart home appliances associated with a room."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListsmarthomeappliancesHandler(cfg),
	}
}
