...
func UpdateaddressbookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateAddressBookRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateAddressBook", cfg.BaseURL)
		...
		var result models.UpdateAddressBookResponse
...
func CreateUpdateaddressbookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateAddressBook",
		mcp.WithDescription("Updates address book details by the address book ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateaddressbookHandler(cfg),
	}
}
