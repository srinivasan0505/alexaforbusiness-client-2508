...
func GetconferencepreferenceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetConferencePreferenceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetConferencePreference", cfg.BaseURL)
		...
		var result models.GetConferencePreferenceResponse
...
func CreateGetconferencepreferenceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetConferencePreference",
		mcp.WithDescription("Retrieves the existing conference preferences."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetconferencepreferenceHandler(cfg),
	}
}
