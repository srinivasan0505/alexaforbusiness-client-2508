...
func UpdategatewaygroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateGatewayGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateGatewayGroup", cfg.BaseURL)
		...
		var result models.UpdateGatewayGroupResponse
...
func CreateUpdategatewaygroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateGatewayGroup",
		mcp.WithDescription("Updates the details of a gateway group. If any optional field is not provided, the existing corresponding value is left unmodified."),
		...
		mcp.WithString("GatewayGroupArn", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdategatewaygroupHandler(cfg),
	}
}
