...
func CreateaddressbookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateAddressBookRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateAddressBook", cfg.BaseURL)
		...
		var result models.CreateAddressBookResponse
...
func CreateCreateaddressbookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateAddressBook",
		mcp.WithDescription("Creates an address book with the specified details."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateaddressbookHandler(cfg),
	}
}
