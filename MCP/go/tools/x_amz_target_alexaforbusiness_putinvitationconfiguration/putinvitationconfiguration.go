...
func PutinvitationconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutInvitationConfigurationRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.PutInvitationConfiguration", cfg.BaseURL)
		...
		var result models.PutInvitationConfigurationResponse
...
func CreatePutinvitationconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_PutInvitationConfiguration",
		mcp.WithDescription("Configures the email template for the user enrollment invitation with the specified attributes."),
		...
		mcp.WithString("OrganizationName", mcp.Required(), mcp.Description("")),
		mcp.WithString("PrivateSkillIds", mcp.Description("")),
		mcp.WithString("ContactEmail", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutinvitationconfigurationHandler(cfg),
	}
}
