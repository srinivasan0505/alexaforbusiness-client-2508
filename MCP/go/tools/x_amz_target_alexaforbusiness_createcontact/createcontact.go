...
func CreatecontactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateContactRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateContact", cfg.BaseURL)
		...
		var result models.CreateContactResponse
...
func CreateCreatecontactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateContact",
		mcp.WithDescription("Creates a contact with the specified details."),
		...
		mcp.WithString("FirstName", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatecontactHandler(cfg),
	}
}
