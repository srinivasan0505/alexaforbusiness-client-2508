...
func CreateroomHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateRoomRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateRoom", cfg.BaseURL)
		...
		var result models.CreateRoomResponse
...
func CreateCreateroomTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateRoom",
		mcp.WithDescription("Creates a room with the specified details."),
		...
		mcp.WithString("RoomName", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreateroomHandler(cfg),
	}
}
