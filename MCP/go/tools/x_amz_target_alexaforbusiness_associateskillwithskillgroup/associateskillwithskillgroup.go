...
func AssociateskillwithskillgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AssociateSkillWithSkillGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.AssociateSkillWithSkillGroup", cfg.BaseURL)
		...
		var result models.AssociateSkillWithSkillGroupResponse
...
func CreateAssociateskillwithskillgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_AssociateSkillWithSkillGroup",
		mcp.WithDescription("Associates a skill with a skill group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AssociateskillwithskillgroupHandler(cfg),
	}
}
