...
func CreateconferenceproviderHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateConferenceProviderRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateConferenceProvider", cfg.BaseURL)
		...
		var result models.CreateConferenceProviderResponse
...
func CreateCreateconferenceproviderTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateConferenceProvider",
		mcp.WithDescription("Adds a new conference provider under the user's AWS account."),
		...
		mcp.WithString("ConferenceProviderName", mcp.Required(), mcp.Description("")),
		mcp.WithString("ConferenceProviderType", mcp.Required(), mcp.Description("")),
		mcp.WithObject("IPDialIn", mcp.Description("")),
		mcp.WithObject("MeetingSetting", mcp.Required(), mcp.Description("")),
		mcp.WithObject("PSTNDialIn", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreateconferenceproviderHandler(cfg),
	}
}
