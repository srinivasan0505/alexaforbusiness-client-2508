...
func DisassociatecontactfromaddressbookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DisassociateContactFromAddressBookRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DisassociateContactFromAddressBook", cfg.BaseURL)
		...
		var result models.DisassociateContactFromAddressBookResponse
...
func CreateDisassociatecontactfromaddressbookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DisassociateContactFromAddressBook",
		mcp.WithDescription("Disassociates a contact from a given address book."),
		...
		mcp.WithString("ContactArn", mcp.Required(), mcp.Description("")),
		mcp.WithString("AddressBookArn", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DisassociatecontactfromaddressbookHandler(cfg),
	}
}
