...
func SearchusersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchUsersRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchUsers%s", cfg.BaseURL, queryString)
		...
		var result models.SearchUsersResponse
...
func CreateSearchusersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchUsers",
		mcp.WithDescription("Searches users and lists the ones that meet a set of filter and sort criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchusersHandler(cfg),
	}
}
