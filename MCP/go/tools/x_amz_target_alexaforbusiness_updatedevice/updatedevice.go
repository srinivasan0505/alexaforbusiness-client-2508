...
func UpdatedeviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateDeviceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateDevice", cfg.BaseURL)
		...
		var result models.UpdateDeviceResponse
...
func CreateUpdatedeviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateDevice",
		mcp.WithDescription("Updates the device name by device ARN."),
		...
		mcp.WithString("DeviceName", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatedeviceHandler(cfg),
	}
}
