...
func ListgatewaygroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListGatewayGroupsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListGatewayGroups%s", cfg.BaseURL, queryString)
		...
		var result models.ListGatewayGroupsResponse
...
func CreateListgatewaygroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListGatewayGroups",
		mcp.WithDescription("Retrieves a list of gateway group summaries. Use GetGatewayGroup to retrieve details of a specific gateway group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListgatewaygroupsHandler(cfg),
	}
}
