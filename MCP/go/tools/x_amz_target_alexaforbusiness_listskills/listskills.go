...
func ListskillsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListSkillsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListSkills%s", cfg.BaseURL, queryString)
		...
		var result models.ListSkillsResponse
...
func CreateListskillsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListSkills",
		mcp.WithDescription("Lists all enabled skills in a specific skill group."),
		...
		mcp.WithString("SkillType", mcp.Description("")),
		mcp.WithString("EnablementType", mcp.Description("")),
		mcp.WithString("MaxResults", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListskillsHandler(cfg),
	}
}
