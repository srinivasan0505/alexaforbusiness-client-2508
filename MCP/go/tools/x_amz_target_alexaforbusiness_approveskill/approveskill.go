...
func ApproveskillHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ApproveSkillRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ApproveSkill", cfg.BaseURL)
		...
		var result models.ApproveSkillResponse
...
func CreateApproveskillTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ApproveSkill",
		mcp.WithDescription("Associates a skill with the organization under the customer's AWS account. If a skill is private, the user implicitly accepts access to this skill during enablement."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ApproveskillHandler(cfg),
	}
}
