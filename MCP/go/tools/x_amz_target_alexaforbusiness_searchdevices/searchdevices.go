...
func SearchdevicesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchDevicesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchDevices%s", cfg.BaseURL, queryString)
		...
		var result models.SearchDevicesResponse
...
func CreateSearchdevicesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchDevices",
		mcp.WithDescription("Searches devices and lists the ones that meet a set of filter criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchdevicesHandler(cfg),
	}
}
