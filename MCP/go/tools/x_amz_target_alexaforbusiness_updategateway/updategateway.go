...
func UpdategatewayHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateGatewayRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateGateway", cfg.BaseURL)
		...
		var result models.UpdateGatewayResponse
...
func CreateUpdategatewayTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateGateway",
		mcp.WithDescription("Updates the details of a gateway. If any optional field is not provided, the existing corresponding value is left unmodified."),
		...
		mcp.WithString("GatewayArn", mcp.Required(), mcp.Description("")),
		mcp.WithString("Name", mcp.Description("")),
		mcp.WithString("SoftwareVersion", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdategatewayHandler(cfg),
	}
}
