...
func GetconferenceproviderHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetConferenceProviderRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetConferenceProvider", cfg.BaseURL)
		...
		var result models.GetConferenceProviderResponse
...
func CreateGetconferenceproviderTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetConferenceProvider",
		mcp.WithDescription("Gets details about a specific conference provider."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetconferenceproviderHandler(cfg),
	}
}
