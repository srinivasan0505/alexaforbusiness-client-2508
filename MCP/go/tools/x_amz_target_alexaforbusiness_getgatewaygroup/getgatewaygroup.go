...
func GetgatewaygroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetGatewayGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetGatewayGroup", cfg.BaseURL)
		...
		var result models.GetGatewayGroupResponse
...
func CreateGetgatewaygroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetGatewayGroup",
		mcp.WithDescription("Retrieves the details of a gateway group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetgatewaygroupHandler(cfg),
	}
}
