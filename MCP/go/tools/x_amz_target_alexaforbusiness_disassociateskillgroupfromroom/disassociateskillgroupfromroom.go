...
func DisassociateskillgroupfromroomHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DisassociateSkillGroupFromRoomRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DisassociateSkillGroupFromRoom", cfg.BaseURL)
		...
		var result models.DisassociateSkillGroupFromRoomResponse
...
func CreateDisassociateskillgroupfromroomTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DisassociateSkillGroupFromRoom",
		mcp.WithDescription("Disassociates a skill group from a specified room. This disables all skills in the skill group on all devices in the room."),
		...
		mcp.WithString("SkillGroupArn", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DisassociateskillgroupfromroomHandler(cfg),
	}
}
