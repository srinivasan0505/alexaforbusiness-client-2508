...
func GetnetworkprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetNetworkProfileRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetNetworkProfile", cfg.BaseURL)
		...
		var result models.GetNetworkProfileResponse
...
func CreateGetnetworkprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetNetworkProfile",
		mcp.WithDescription("Gets the network profile details by the network profile ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetnetworkprofileHandler(cfg),
	}
}
