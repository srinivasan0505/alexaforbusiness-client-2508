...
func DisassociateskillfromskillgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DisassociateSkillFromSkillGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DisassociateSkillFromSkillGroup", cfg.BaseURL)
		...
		var result models.DisassociateSkillFromSkillGroupResponse
...
func CreateDisassociateskillfromskillgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DisassociateSkillFromSkillGroup",
		mcp.WithDescription("Disassociates a skill from a skill group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DisassociateskillfromskillgroupHandler(cfg),
	}
}
