...
func AssociatedevicewithnetworkprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AssociateDeviceWithNetworkProfileRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.AssociateDeviceWithNetworkProfile", cfg.BaseURL)
		...
		var result models.AssociateDeviceWithNetworkProfileResponse
...
func CreateAssociatedevicewithnetworkprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_AssociateDeviceWithNetworkProfile",
		mcp.WithDescription("Associates a device with the specified network profile."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AssociatedevicewithnetworkprofileHandler(cfg),
	}
}
