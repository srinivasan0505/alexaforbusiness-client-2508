...
func GetgatewayHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetGatewayRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetGateway", cfg.BaseURL)
		...
		var result models.GetGatewayResponse
...
func CreateGetgatewayTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetGateway",
		mcp.WithDescription("Retrieves the details of a gateway."),
