...
func UpdatenetworkprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateNetworkProfileRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateNetworkProfile", cfg.BaseURL)
		...
		var result models.UpdateNetworkProfileResponse
...
func CreateUpdatenetworkprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateNetworkProfile",
		mcp.WithDescription("Updates a network profile by the network profile ARN."),
		...
		mcp.WithString("NetworkProfileName", mcp.Description("")),
		...
		mcp.WithString("NetworkProfileArn", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatenetworkprofileHandler(cfg),
	}
}
