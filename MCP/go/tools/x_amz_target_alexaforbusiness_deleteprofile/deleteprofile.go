...
func DeleteprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteProfileRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteProfile", cfg.BaseURL)
		...
		var result models.DeleteProfileResponse
...
func CreateDeleteprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteProfile",
		mcp.WithDescription("Deletes a room profile by the profile ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteprofileHandler(cfg),
	}
}
