...
func DeletebusinessreportscheduleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteBusinessReportScheduleRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteBusinessReportSchedule", cfg.BaseURL)
		...
		var result models.DeleteBusinessReportScheduleResponse
...
func CreateDeletebusinessreportscheduleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteBusinessReportSchedule",
		mcp.WithDescription("Deletes the recurring report delivery schedule with the specified schedule ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletebusinessreportscheduleHandler(cfg),
	}
}
