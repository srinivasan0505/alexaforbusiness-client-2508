...
func DeleteskillauthorizationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteSkillAuthorizationRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteSkillAuthorization", cfg.BaseURL)
		...
		var result models.DeleteSkillAuthorizationResponse
...
func CreateDeleteskillauthorizationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteSkillAuthorization",
		mcp.WithDescription("Unlinks a third-party account from a skill."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteskillauthorizationHandler(cfg),
	}
}
