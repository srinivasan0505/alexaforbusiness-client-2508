...
func PutconferencepreferenceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutConferencePreferenceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.PutConferencePreference", cfg.BaseURL)
		...
		var result models.PutConferencePreferenceResponse
...
func CreatePutconferencepreferenceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_PutConferencePreference",
		mcp.WithDescription("Sets the conference preferences on a specific conference provider at the account level."),
		...
		mcp.WithObject("ConferencePreference", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutconferencepreferenceHandler(cfg),
	}
}
