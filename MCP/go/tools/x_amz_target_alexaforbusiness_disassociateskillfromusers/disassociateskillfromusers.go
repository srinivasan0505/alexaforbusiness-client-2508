...
func DisassociateskillfromusersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DisassociateSkillFromUsersRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DisassociateSkillFromUsers", cfg.BaseURL)
		...
		var result models.DisassociateSkillFromUsersResponse
...
func CreateDisassociateskillfromusersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DisassociateSkillFromUsers",
		mcp.WithDescription("Makes a private skill unavailable for enrolled users and prevents them from enabling it on their devices."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DisassociateskillfromusersHandler(cfg),
	}
}
