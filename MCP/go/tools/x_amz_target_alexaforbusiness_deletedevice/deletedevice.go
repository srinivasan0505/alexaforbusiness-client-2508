...
func DeletedeviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteDeviceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteDevice", cfg.BaseURL)
		...
		var result models.DeleteDeviceResponse
...
func CreateDeletedeviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteDevice",
		mcp.WithDescription("Removes a device from Alexa For Business."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletedeviceHandler(cfg),
	}
}
