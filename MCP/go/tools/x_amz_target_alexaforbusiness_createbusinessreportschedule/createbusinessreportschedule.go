...
func CreatebusinessreportscheduleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateBusinessReportScheduleRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateBusinessReportSchedule", cfg.BaseURL)
		...
		var result models.CreateBusinessReportScheduleResponse
...
func CreateCreatebusinessreportscheduleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateBusinessReportSchedule",
		mcp.WithDescription("Creates a recurring schedule for usage reports to deliver to the specified S3 location with a specified daily or weekly interval."),
		...
		mcp.WithObject("Recurrence", mcp.Description("")),
		mcp.WithString("S3BucketName", mcp.Description("")),
		mcp.WithString("S3KeyPrefix", mcp.Description("")),
		mcp.WithString("ScheduleName", mcp.Description("")),
		mcp.WithString("Tags", mcp.Description("")),
		mcp.WithString("ClientRequestToken", mcp.Description("")),
		mcp.WithObject("ContentRange", mcp.Required(), mcp.Description("")),
		mcp.WithString("Format", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreatebusinessreportscheduleHandler(cfg),
	}
}
