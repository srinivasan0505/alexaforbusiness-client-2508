...
func UpdateskillgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateSkillGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.UpdateSkillGroup", cfg.BaseURL)
		...
		var result models.UpdateSkillGroupResponse
...
func CreateUpdateskillgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_UpdateSkillGroup",
		mcp.WithDescription("Updates skill group details by skill group ARN."),
		...
		mcp.WithString("SkillGroupName", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateskillgroupHandler(cfg),
	}
}
