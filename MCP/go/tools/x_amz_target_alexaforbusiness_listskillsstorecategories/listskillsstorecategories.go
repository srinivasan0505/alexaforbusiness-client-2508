...
func ListskillsstorecategoriesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListSkillsStoreCategoriesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListSkillsStoreCategories%s", cfg.BaseURL, queryString)
		...
		var result models.ListSkillsStoreCategoriesResponse
...
func CreateListskillsstorecategoriesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListSkillsStoreCategories",
		mcp.WithDescription("Lists all categories in the Alexa skill store."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListskillsstorecategoriesHandler(cfg),
	}
}
