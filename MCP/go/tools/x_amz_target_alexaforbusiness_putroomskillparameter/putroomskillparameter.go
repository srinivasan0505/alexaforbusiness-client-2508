...
func PutroomskillparameterHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutRoomSkillParameterRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.PutRoomSkillParameter", cfg.BaseURL)
		...
		var result models.PutRoomSkillParameterResponse
...
func CreatePutroomskillparameterTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_PutRoomSkillParameter",
		mcp.WithDescription("Updates room skill parameter details by room, skill, and parameter key ID. Not all skills have a room skill parameter."),
		...
		mcp.WithObject("RoomSkillParameter", mcp.Required(), mcp.Description("")),
		mcp.WithString("SkillId", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutroomskillparameterHandler(cfg),
	}
}
