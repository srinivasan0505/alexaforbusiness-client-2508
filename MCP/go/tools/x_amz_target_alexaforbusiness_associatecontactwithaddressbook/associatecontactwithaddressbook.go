...
func AssociatecontactwithaddressbookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AssociateContactWithAddressBookRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.AssociateContactWithAddressBook", cfg.BaseURL)
		...
		var result models.AssociateContactWithAddressBookResponse
...
func CreateAssociatecontactwithaddressbookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_AssociateContactWithAddressBook",
		mcp.WithDescription("Associates a contact with a given address book."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AssociatecontactwithaddressbookHandler(cfg),
	}
}
