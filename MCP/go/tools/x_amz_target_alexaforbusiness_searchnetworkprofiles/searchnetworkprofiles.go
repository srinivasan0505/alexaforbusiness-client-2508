...
func SearchnetworkprofilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchNetworkProfilesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchNetworkProfiles%s", cfg.BaseURL, queryString)
		...
		var result models.SearchNetworkProfilesResponse
...
func CreateSearchnetworkprofilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchNetworkProfiles",
		mcp.WithDescription("Searches network profiles and lists the ones that meet a set of filter and sort criteria."),
		...
		mcp.WithString("SortCriteria", mcp.Description("")),
		mcp.WithString("Filters", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    SearchnetworkprofilesHandler(cfg),
	}
}
