...
func AssociateskillwithusersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AssociateSkillWithUsersRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.AssociateSkillWithUsers", cfg.BaseURL)
		...
		var result models.AssociateSkillWithUsersResponse
...
func CreateAssociateskillwithusersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_AssociateSkillWithUsers",
		mcp.WithDescription("Makes a private skill available for enrolled users to enable on their devices."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AssociateskillwithusersHandler(cfg),
	}
}
