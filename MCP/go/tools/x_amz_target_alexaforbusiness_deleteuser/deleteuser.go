...
func DeleteuserHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteUserRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteUser", cfg.BaseURL)
		...
		var result models.DeleteUserResponse
...
func CreateDeleteuserTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteUser",
		mcp.WithDescription("Deletes a specified user by user ARN and enrollment ARN."),
		...
		mcp.WithString("EnrollmentId", mcp.Required(), mcp.Description("")),
