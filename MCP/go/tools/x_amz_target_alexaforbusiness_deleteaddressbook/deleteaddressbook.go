...
func DeleteaddressbookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteAddressBookRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteAddressBook", cfg.BaseURL)
		...
		var result models.DeleteAddressBookResponse
...
func CreateDeleteaddressbookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteAddressBook",
		mcp.WithDescription("Deletes an address book by the address book ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteaddressbookHandler(cfg),
	}
}
