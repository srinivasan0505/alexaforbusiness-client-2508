...
func GetroomskillparameterHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetRoomSkillParameterRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetRoomSkillParameter", cfg.BaseURL)
		...
		var result models.GetRoomSkillParameterResponse
...
func CreateGetroomskillparameterTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetRoomSkillParameter",
		mcp.WithDescription("Gets room skill parameter details by room, skill, and parameter key ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetroomskillparameterHandler(cfg),
	}
}
