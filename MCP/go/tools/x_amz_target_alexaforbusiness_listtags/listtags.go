...
func ListtagsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListTagsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.ListTags%s", cfg.BaseURL, queryString)
...
func CreateListtagsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_ListTags",
		mcp.WithDescription("Lists all tags for the specified resource."),
		...
		mcp.WithString("Arn", mcp.Required(), mcp.Description("")),
