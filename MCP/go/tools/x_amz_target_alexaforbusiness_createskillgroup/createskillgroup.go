...
func CreateskillgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateSkillGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.CreateSkillGroup", cfg.BaseURL)
		...
		var result models.CreateSkillGroupResponse
...
func CreateCreateskillgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_CreateSkillGroup",
		mcp.WithDescription("Creates a skill group with a specified name and description."),
		...
		mcp.WithString("SkillGroupName", mcp.Required(), mcp.Description("")),
		mcp.WithString("Tags", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreateskillgroupHandler(cfg),
	}
}
