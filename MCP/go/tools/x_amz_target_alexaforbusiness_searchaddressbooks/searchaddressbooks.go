...
func SearchaddressbooksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchAddressBooksRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchAddressBooks%s", cfg.BaseURL, queryString)
		...
		var result models.SearchAddressBooksResponse
...
func CreateSearchaddressbooksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchAddressBooks",
		mcp.WithDescription("Searches address books and lists the ones that meet a set of filter and sort criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchaddressbooksHandler(cfg),
	}
}
