...
func DeletegatewaygroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteGatewayGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteGatewayGroup", cfg.BaseURL)
		...
		var result models.DeleteGatewayGroupResponse
...
func CreateDeletegatewaygroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteGatewayGroup",
		mcp.WithDescription("Deletes a gateway group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletegatewaygroupHandler(cfg),
	}
}
