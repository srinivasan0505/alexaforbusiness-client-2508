...
func DeleteskillgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteSkillGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.DeleteSkillGroup", cfg.BaseURL)
		...
		var result models.DeleteSkillGroupResponse
...
func CreateDeleteskillgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_DeleteSkillGroup",
		mcp.WithDescription("Deletes a skill group by skill group ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteskillgroupHandler(cfg),
	}
}
