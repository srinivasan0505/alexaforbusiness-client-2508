...
func GetaddressbookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetAddressBookRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetAddressBook", cfg.BaseURL)
		...
		var result models.GetAddressBookResponse
...
func CreateGetaddressbookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetAddressBook",
		mcp.WithDescription("Gets address the book details by the address book ARN."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetaddressbookHandler(cfg),
	}
}
