...
func SearchcontactsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchContactsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchContacts%s", cfg.BaseURL, queryString)
...
func CreateSearchcontactsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchContacts",
		mcp.WithDescription("Searches contacts and lists the ones that meet a set of filter and sort criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchcontactsHandler(cfg),
	}
}
