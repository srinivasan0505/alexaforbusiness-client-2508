...
func SearchroomsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SearchRoomsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.SearchRooms%s", cfg.BaseURL, queryString)
		...
		var result models.SearchRoomsResponse
...
func CreateSearchroomsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_SearchRooms",
		mcp.WithDescription("Searches rooms and lists the ones that meet a set of filter and sort criteria."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchroomsHandler(cfg),
	}
}
