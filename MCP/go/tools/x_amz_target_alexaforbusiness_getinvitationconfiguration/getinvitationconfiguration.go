...
func GetinvitationconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetInvitationConfigurationRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AlexaForBusiness.GetInvitationConfiguration", cfg.BaseURL)
		...
		var result models.GetInvitationConfigurationResponse
...
func CreateGetinvitationconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AlexaForBusiness_GetInvitationConfiguration",
		mcp.WithDescription("Retrieves the configured values for the user enrollment invitation email template."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetinvitationconfigurationHandler(cfg),
	}
}
